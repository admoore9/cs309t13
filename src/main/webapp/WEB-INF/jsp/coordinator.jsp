			...
			<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
				...
				<div id="accordion" class="panel-group">
					...
					<div id="my-teams-panel" class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								<a data-toggle="collapse" data-target="#my-tournaments-content"
									href="#my-tournaments-content"> Manage My Teams </a>
							</h3>
						</div>
						<div class="panel panel-collapse collapse"
							...
							<div class="panel-body">
								<c:forEach items="${tournaments}" var="tournament">
									<div id="teams-${tournament.name}-panel"
										class="panel panel-default">
										<div class="panel-heading">
											<h3 class="panel-title">
												<a data-toggle="collapse"
													data-target="#my-${tournament.name}-teams"
													href="#my-${tournament.name}-teams"> ${tournament.name}
												</a>
											</h3>
										</div>
										<div class="panel panel-collapse collapse"
					...
					<div id="my-games-panel" class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">
								<a data-toggle="collapse" data-target="#my-games-content"
									href="#my-games-content"> Manage My Games </a>
							</h3>
						</div>
						<div class="panel panel-collapse collapse" id="my-games-content">
							<div class="panel-body">
								<c:forEach items="${tournaments}" var="tournament">
									<div id="games-${tournament.name}-panel"
										class="panel panel-default">
										<div class="panel-heading">
											<h3 class="panel-title">
												<a data-toggle="collapse"
													data-target="#my-${tournament.name}-games"
													href="#my-${tournament.name}-games"> ${tournament.name}
												</a>
											</h3>
										</div>
										<div class="panel panel-collapse collapse"
